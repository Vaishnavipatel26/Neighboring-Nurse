            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="App.php" aria-expanded="false"><i class="me-3 fa fa-check"></i><span class="hide-menu">Post</span></a></li>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="Hospital_logo.jpg" class="rounded-circle" width="150" />
                                    <h4 class="card-title mt-2"><b>City Hospital</b><br><br>Certified</h4>
                                </center>
                            </div>
                        </div>
                    </div>
                                ...
                                <form class="form-horizontal form-material mx-2" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex ">
											...
											<button type="button" class="btn btn-success mx-3 text-white" style="background-color:rgba(63,187,192,255) ; border:0px;" onclick="window.location.href=''">Edit Profile
                                            </button>
											
											<button type="button" class="btn btn-success mx-3 text-white" style="background-color:rgba(63,187,192,255) ; border:0px;" onclick="window.location.href=''">Create Post
                                            </button>
